...
def main():
    ...
    parser.add_argument("--output_dir", default=saveDir, type=str, required=False,
                        help="The output directory where the model checkpoints and predictions will be written.")

    ## Other parameters
    parser.add_argument("--train_file", default="./train-v2.0.json", type=str, help="SQuAD json for training. E.g., train-v1.1.json")
